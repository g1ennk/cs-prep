...
- 메모리 효율성: String Intern Pool로 동일한 리터럴(문자열)을 하나의 객체로 공유하여, 중복 생성이 감소하고 메모리를 절감한다.
...
- 또한 생성자로 생성된 문자열도 `intern()` 메서드를 사용하면 Heap 영역에 저장된 String 객체를 String Intern Pool에 저장할 수 있다.
